...
export async function precontent(config, pack) {
    ...
    lib.init.css(lib.assetURL + 'extension/东方project', 'extension');
	game.import('character', function () {
		...
		var mingzhi = {
			...
			character: {
				...
				"gezi_aqua": ['female', 'qun', 3, ['gezi_yuyin', 'gezi_qingqu'], ["des:阿库娅绝对是个受智障诅咒的名字<br><b>出自：火焰纹章 if 画师：輪回666</b>"]],
			},
		}
		for (var i in mingzhi.character) {
		    ...
		    [],//0灵
		    [],//1灵
		    ['re_lunasa','gezi_aqua'],//2灵
		    [],//3灵 默认
		    ['re_lyrica'],//4灵
		    []//5灵
		    ].findIndex(fn => fn.includes(i));
		    if (dfliliset) mingzhi.character[i][4].push('dflili:'+dfliliset);
	...
	game.import('character', function () {
		...
		var library_luanru = {
			...
			character: {
				...
				'gezi_bb': ['female', 'wei', 3, ['gezi_shiguan', 'gezi_jinbei', 'gezi_ccc'], ["des:“所以就算你喜欢我也没用哦？哪怕你被BB亲迷得神魂颠倒，也绝对无法抓住我啦！”BB一脸自豪地如是说。<br>出自:Fate/Extra CCC<b>画师：swd3e2（隋文帝）</b>"]],
				...
				'blackmagicgirl': ['female', 'wei', 3, ['gezi_daomo', 'gezi_chuancheng', 'gezi_dba'], ["des:自从出现后就没停止过出本子的劳模。<br>出自：游戏王<b> 画师：Seinen 设计：黑白葱</b>"]],
				"gezi_rin": ["female", "wei", 3, ["gezi_cuican", "gezi_shanyao"], ["des:我去练撑杆跳能找到这么萌的妹子吗？<br>出自：Fate/StayNight <b>画师：基月</b>"]],
				"gezi_FSakura": ["female", "wei", 3, ["gezi_jiushu", "gezi_mengsui"], ["des:笑容最美丽反而内心是最痛苦的<br>出自：Fate/StayNight <b>画师：bomhat</b>"]],
				gezi_fate_sakura: ['female', 'wei', 3, ['gezi_jiushu', 'gezi_yingmeng'], []],
				...
				'gezi_saberxt': ['female', 'shu', 4, ['gezi_xingtu', 'gezi_shijian'], ["des:怎么在哪都要打圣杯<br>出自：崩坏·星穹铁道 <b>画师：未知</b>"]],
				...
				gezi_gilgamesh: ['male', 'wei', 3, ['gezi_wanglv', 'gezi_tiansuo', 'gezi_enuma_elish'], []],
				gezi_nero_claus: ['female', 'shu', 4, ['gezi_muqi', 'gezi_XmasEveTheater'], []],
				gezi_helena: ['female', 'shu', 3, ['gezi_tongdiao', 'gezi_tanqiu', 'gezi_Sanat_Kumara'], []],
				gezi_Mysterious_Heroine_X: ['female', 'shu', 4, ['gezi_guangcai', 'gezi_X_yuanhu', 'gezi_Himitsu_Calibur'], []],
				gezi_unknown_eks: ['female', 'wei', 4, ['gezi_anduan', 'gezi_wangshou', 'gezi_Cross_Calibur'], []],
				gezi_jeanne: ['female', 'shu', 4, ['gezi_qishi', 'gezi_ask_amen', 'gezi_Immanuel'], []],
				gezi_sb_zhouyu: ['female', 'wu', 4, ['gezi_sb_yingzi', 'gezi_ZijueCard'], []],
				gezi_chenglian: ['male', 'shu', 3, ['gezi_ww_jinbei'], []],
				gezi_ironmaiden: ['female', 'qun', 3, ['gezi_holy_girl', 'gezi_save_vow', "gezi_Samash"], []],
				gezi_jolyne: ['female', 'shu', 4, ['stone_free', 'gezi_ora_punch', 'gezi_kilo_hits'], []],
				stone_free: ['female', 'shu', 4, ['stone_free'], ["minskin", "unseen", "forbidai"]],
				gezi_sento_isuzu: ['female', 'shu', 4, ['gezi_moqiang', 'gezi_modan'], []],
				gezi_kirihime_yoruka: ['female', 'shu', 4, ['gezi_xiongren', 'gezi_BahamutYatoKami'], []],
				gezi_eucliwood: ['female', 'shu', 4, ['gezi_eu_silent', 'gezi_eu_angry'], []],
				gezi_shana: ['female', 'shu', 4, ['gezi_huodao', 'gezi_tianhuo'], []],
				gezi_michele: ['female', 'wu', 3, ['gezi_xianhua', 'gezi_miao2paota', 'gezi_meowblast'], []],
				gezi_lanran: ['male', 'wei', '3/4', ['gezi_jinghua', 'gezi_lingya', 'gezi_pojian'], []],
				gezi_hinata: ['female', 'wei', 3, ['gezi_huitian', 'gezi_doublelion'], []],
				'gezi_giriyu': ['female', 'shu', 3, ['gezi_jingyuan', 'gezi_yishen'], ["des:“蝴蝶结，平胸，巫女服，阴阳玉，御币，符纸，毫无疑问，这就是博丽灵梦”“我不姓博丽，你丫再认错人我就用这御币敲碎你的狗头”“我超，嘉——”(砰！！！！)<br>出自：魔女兵器 <b>画师：未知</b>"]],
				'gezi_miyu': ['female', 'wei', 3, ['gezi_yizhi', 'gezi_shenzhi', 'gezi_shuoyue'], ["des:全名美游·艾德费尔特，“你好初次见面穿刺死棘之枪。”<br>出自：Fate/kaleid liner 魔法少女☆伊莉雅 <b>画师：</b>"]],
			},
		};
		...
		for (var i in library_luanru.character) {
		    var dfliliset=[
		    [],//0灵
		    ['gezi_illyasviel','gezi_kuro','gezi_scathach','gezi_twob','gezi_FSakura','gezi_fate_sakura','gezi_gilgamesh','gezi_unknown_eks','gezi_jeanne','gezi_sb_zhouyu','gezi_chenglian'],//1灵
		    ['gezi_nero','gezi_nerowedding','gezi_bb','gezi_kurumi','gezi_shigure','gezi_yudachi','gezi_m4a1','gezi_satone','gezi_arisa','gezi_tsubaki','niuzhanshi','blackmagicgirl','gezi_nero_claus','gezi_helena','gezi_Mysterious_Heroine_X','gezi_jolyne','gezi_sento_isuzu','gezi_kirihime_yoruka','gezi_eucliwood','gezi_shana','gezi_giriyu'],//2灵
		    [],//3灵 默认
		    ['gezi_megumin','gezi_ironmaiden','gezi_miyu'],//4灵
		    []//5灵
		    ].findIndex(fn => fn.includes(i));
		    if (dfliliset) library_luanru.character[i][4].push('dflili:'+dfliliset);
	...
	game.import('character', function () {
		...
		var library = {
			...
			character: {
				...
				'gezi_sanae': ['female', 'shu', 3, ['gezi_qiji', 'gezi_omikuji'], []],
				'gezi_kanako': ['female', 'shu', 4, ['gezi_yushe', 'gezi_shende'], []],
				'gezi_hina': ['female', 'shu', 3, ['gezi_chuanran', 'gezi_eyun'], []],
				'gezi_sizuha': ['female', 'shu', 4, ['gezi_shuangsi', 'gezi_rangtian'], []],
				'gezi_minoriko': ['female', 'shu', 3, ['gezi_dayou', 'gezi_rangtian'], []],				
				gezi_Yorihime: ['female', 'wei', 4, ['gezi_shenping','gezi_renfan'], []],
			},
		}
		for (var i in library.character) {
		    ...
		    [],//0灵
		    [],//1灵
		    ['gezi_minoriko','gezi_sizuha','gezi_hina','gezi_kanako','gezi_sanae'],//2灵
		    [],//3灵 默认
		    [],//4灵
		    []//5灵
		    ].findIndex(fn => fn.includes(i));
		    if (dfliliset) library.character[i][4].push('dflili:'+dfliliset);
	...
	game.import('character', function () {
		...
		for (var i in TouhouProject.character) {
		    var dfliliset=[
		    ['gezi_meribel'],//0灵
		    ['gezi_flandre','gezi_suika','gezi_eirin','gezi_kaguya','gezi_mokou','gezi_yuyuko','gezi_lilyblack','gezi_medicine','gezi_yuuka','gezi_eiki','gezi_yukari'],//1灵
		    ['gezi_meiling','gezi_patchouli','gezi_sakuya','gezi_reimu','gezi_marisa','gezi_reisen','gezi_lunasa','gezi_alice','gezi_aya','gezi_hetate','gezi_ran'],//2灵
		    [],//3灵 默认
		    ['gezi_rumia','gezi_koakuma','gezi_cirno','gezi_wriggle','gezi_mystia','gezi_lyrica'],//4灵
		    ['gezi_remilia','gezi_daiyousei','gezi_lilywhite']//5灵
		    ].findIndex(fn => fn.includes(i));
		    if (dfliliset) TouhouProject.character[i][4].push('dflili:'+dfliliset);
	...
	game.addCardPack({
		card: {
			holysword: {
				...
				skills: ['ziheng_skill_shengjian', 'jinu_skill', 'gezi_lianji_skill'],
			},
			spell_wuyashenxiang: {
	...
	//这行在语法上是“标签语句”（labeled statement）：image: 是给后面的表达式语句（这里是一个数组字面量）加了一个标签。标签语句在 JS 里是合法的（通常配合 break/continue 使用），但它本身不做任何事。
	...
	game.addMode('old_identity', {
		...
		start: function () {
			...
			//bUI下向导很搞，直接跳过(跳过厨吗你)
			if (game.hasExtension("十周年UI")&&!lib.config.old_tutorial){
	...
	game.addMode('stg', {
		...
		skill: {
			...
			reinforce: {
				...
				content: function () {
					var num = [1, 2, 3, 5, 6, 7];
					game.players.forEach(current => num.remove(current.dataset.position));
