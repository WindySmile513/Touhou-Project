	...
	return {
		...
		start:function(){
			...
			var step1=function(){
				...
				var word = ui.create.div('欢迎来到无名杀！<br>请问您的名字是什么？<br><br><br><div><div style="text-align:center;font-size:14px">这个名字以后可以修改。</div><br>');
				dialog.style.display='flex';
				dialog.appendChild(word);
				var text2=ui.create.div(".shadowed");
					text2.style.width='200px';
					text2.style.height='20px';
					text2.style.padding='0';
					text2.style.position='center';
